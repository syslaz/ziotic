...
//                                }
    ...
    public static void load() throws IOException {
        ...
        try {
             ...
             */
            potions = (Map<String, Potion>) Static.xml.readObject(Static.parseString("%WORK_DIR%/potiondefs.xml"));
            foods = (Map<String, EatableFood>) Static.xml.readObject(Static.parseString("%WORK_DIR%/food.xml"));
